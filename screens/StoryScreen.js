...
import { RFValue } from "react-native-responsive-fontsize"; // responsive fontsize

import firebase from "firebase";

// other important expo libraries:
...
export default class StoryScreen extends React.Component {
  ...
  render() {
    const story = this.props.route.params.story.value;
